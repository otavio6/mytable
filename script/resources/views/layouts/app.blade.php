...
<body class="font-sans antialiased bg-[#14171a] text-gray-200 cursor-default scrollbar-hide" id="main-body">
    {{-- Immersive background glows --}}
    <div class="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_50%_0%,rgba(245,158,11,0.05)_0%,transparent_50%),radial-gradient(circle_at_100%_100%,rgba(30,58,138,0.03)_0%,transparent_50%)] pointer-events-none"></div>
    ...
    <div class="flex rtl:flex-row-reverse pt-20 overflow-hidden h-screen p-4 md:p-6 lg:p-8 gap-6 md:gap-8">
        ...
        <div id="main-content"
            class="relative w-full h-full overflow-hidden glass rounded-[3rem] border-white/[0.05]">
            <main class="h-full overflow-y-auto p-4 md:p-8 lg:p-10 scrollbar-hide">
                @yield('content')
                {{ $slot ?? '' }}
            </main>
        </div>
