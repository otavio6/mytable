<div class="p-6 glass rounded-[2.5rem] border-white/5 shadow-2xl overflow-hidden relative">
    <div
    ...
    <div class="flex items-center justify-between mb-4">
        <div class="flex-shrink-0">
            <span
                class="text-xl font-bold leading-none text-gray-900 sm:text-2xl dark:text-white">{{ currency_format($monthlyEarnings, restaurant()->currency_id) }}</span>
            <h3 class="text-base font-light text-gray-500 dark:text-gray-400">@lang('modules.dashboard.salesThisMonth')
            </h3>
        </div>
