...
<div x-data="{ show: @entangle($attributes->wire('model')) }" x-on:close.stop="show = false"
    ...
    class="jetstream-modal fixed inset-0 overflow-y-auto px-4 py-6 sm:px-0 z-[70]" style="display: none;">
    <!-- Overlay -->
    ...
    <!-- Sliding Modal -->
    <div x-show="show"
        class="mb-6 bg-white dark:bg-gray-800 overflow-auto shadow-xl transform transition-all fixed top-0 right-0 sm:w-full h-screen {{ $maxWidth }}"
