<div @class([
    'flex-col gap-3 items-center glass-interactive rounded-2xl border-white/5 p-4 relative overflow-hidden',
])>
    <div class="absolute top-0 right-0 w-24 h-24 bg-primary/5 blur-2xl rounded-full -translate-y-1/2 translate-x-1/2"></div>
